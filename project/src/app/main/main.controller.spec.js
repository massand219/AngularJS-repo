(function() {
  ...
  describe('CONTROLLER: MainController', function() {
    ...
    beforeEach(inject(function($controller) {
      toTest = $controller('MainController')
    }));

    it('should display name and age correctly', function() {
      expect(toTest.add).toBeDefined();
    })
  });
  ...
  //   it('should add the songs to the playlist list correctly', function() {
  //     var myArray = [selectedSongs];
  //     var result = toTest.songSelector(myArray);
